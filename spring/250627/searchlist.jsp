...
<body>
    <div class="container mt-5">
        ...
        onclick="location.href='/reboard/writeform'">글쓰기</button>
     	...
     	<!-- 검색영역 -->
     	<form action="/reboard/search" method="get">
     	<span>
     	...
     	<input type="text" name="search" placeholder="검색입력">
     	<!-- <input type="date" name="startserarchdate">~
     	<input type="date" name="endserarchdate"> -->
        ...
        <nav aria-label="Page navigation">
            <ul class="pagination justify-content-center">
               ...
               <li id="pre" class="page-item ${pageList.pre ? '' : 'disabled'} ">
                    <a class="page-link" href="/reboard/search?requestPage=${pageList.startPage-5}&searchfield=${pageList.searchfield}&search=${pageList.search}" tabindex="-1">이전</a>
               </li>
             ...
             step="1" var="i">
             	...
             	<li class="page-item">
                <a class="page-link active" href="/reboard/search?requestPage=${i}&searchfield=${pageList.searchfield}&search=${pageList.search}">${i}</a>
                </li>
             	</c:if>
             	
             	<c:if test="${pageList.currentPage ne i }">
             	<li class="page-item">
                	<a class="page-link " href="/reboard/search?requestPage=${i}&searchfield=${pageList.searchfield}&search=${pageList.search}">${i}</a>
                </li>
             	</c:if>
             </c:forEach>
             ...
             <c:if test="${pageList.next}">
                <li class="page-item">
                    <a class="page-link" 
                    href="/reboard/search?requestPage=${pageList.startPage+5}">다음</a>
                </li>
             </c:if> 
             </ul>
        </nav>
